...
**== Если тебе не доступен к выполнению проект *C2_SimpleBashUtils* ==**
...
##### Для этого самостоятельно напиши тесты на проект из папки code-samples. Тесты могут быть написаны на любом языке (c, bash, python и т.д.) и должны вызывать собранное приложение для проверки его работоспособности на разных случаях.
